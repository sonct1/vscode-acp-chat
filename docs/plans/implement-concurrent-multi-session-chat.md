...
4. Bật mặc định sau khi automated tests và manual verification đạt acceptance criteria.
5. Giữ setting `multiSession.enabled=false` như operational rollback khi cần quay về legacy single-session mode.
